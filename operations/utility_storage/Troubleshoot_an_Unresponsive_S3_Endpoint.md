...
1. Check the invidivual endpoints.
   ...
   **`NOTE:`** If an error occurs with the above script, then echo $num_storage_nodes.  If it is not an interger that matches the known configuration of the number of Utility Storage nodes, then you can run cloud-init init to refresh your cloud-init cache.  Alternatively you can manually set that number if you know your number of Utility Storage nodes.
