...
1. Reweigh the OSD(s) being removed to rebalance the cluster.
    ...
    1. Change the weight of the OSD being removed to 0.
        ...
        The `OSD_ID` value should be replaced with the ID of the OSD being removed.
        For example, if the ID is `osd.1`, the `OSD_ID` value would be 1 in the command below.
