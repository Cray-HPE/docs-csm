...
Correcting the timeout value is a good troubleshooting option for when Boot Orchestration Service \(BOS\) sessions hang waiting for nodes to be in a `Ready` state.
