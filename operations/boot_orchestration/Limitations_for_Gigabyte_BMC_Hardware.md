...
Gigabyte hardware treats power off and power on requests as successful, whether or not
the power operation actually completed successfully.
...
The workaround for customers with Gigabyte BMC hardware is to manually serialize power off events.
This is done to prevent frequent power actions from being attempted and ignored by CAPMC.
