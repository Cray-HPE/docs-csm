...
Here, `session_name` corresponds to the [CFS session](../configuration_management/CFS_Sessions.md) that is acting on the
[CFS component](../configuration_management/CFS_Components.md) (`x3000c0s1b0n0` in this example), and not the BOS session.
