...
```screen
ncn-mw# cray hsm partitions members list PARTITION_NAME --format json
```
...
```screen
ncn-mw# cray hsm partitions members create --id COMPONENT_ID PARTITION_NAME
```

For example:

```screen
ncn-mw# cray hsm partitions members create --id x1c0s0b0n0 partition1
```
...
```screen
ncn-mw# cray hsm partitions members delete MEMBER_ID PARTITION_NAME
```

For example:

```screen
ncn-mw# cray hsm partitions members delete x1c0s0b0n0 partition1
```
