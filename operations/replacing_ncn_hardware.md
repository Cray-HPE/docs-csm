# Replacing NCN Hardware 

TODO This information is full of STUB comments and is very incomplete.  Some of this appears in other forms in the Admin Guide.  The topics fit here with the CSM install documentation since the process of installation can uncover broken hardware but there may be a desire to not restart the entire installation.
TODO Split this into separate use cases.
...
> **NOTE:** These instructions only apply prior to booting off the LiveCD -- once that step is complete refer 
> to "Rebuild NCNs" in the _HPE Cray EX Hardware Management Administration Guide 1.5 S-8015_.
