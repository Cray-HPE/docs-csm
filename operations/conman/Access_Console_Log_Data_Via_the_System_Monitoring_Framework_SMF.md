...
1. Navigate to the following URL in a web browser: `https://sma-kibana.SYSTEM_DOMAIN_NAME/app/kibana`
    ...
    |**the error `Kibana did not load properly. Check the server output for more information.`**|Clear browser cookies for `https://sma-kibana.SYSTEM_DOMAIN_NAME`|
