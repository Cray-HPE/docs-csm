...
to use [Automatic Configuration Management](Configuration_Management_with_the_CFS_Batcher.md).
...
Jun 19 16:45:24 ncn-m001 python3[12443]: https://api-gw-service-nmn.local:443 "PATCH /apis/cfs/v2/components/x3000c0s1b0n0 HTTP/1.1" 200 191
...
* [Automatic Configuration Management](Configuration_Management_with_the_CFS_Batcher.md)
* [Automated session flow](CFS_Flow_Diagrams.md#automated-session-flow)
* [CFS Components](Configuration_Management_of_System_Components.md)
