...
session using the CFS sessions endpoint.

![Single Session Flow](../../img/operations/CFS_Single_Session_Flow.png)

1. A user creates a [CFS configuration](Configuration_Layers.md).
...
1. A user sets the desired configuration for some number of [components](Configuration_Management_of_System_Components.md).
