...
However, it possible to add additional critical services to the list. For further information on managing the critical services, refer to [Manage Critical Service](/docs-csm/operations/rack_resiliency/Managed_Critical_Services.md)

The Resiliency Monitoring Service and the API service monitor and manage the critical services using a set of configmaps. For more details on the configmap and its attributes refer to [ConfigMaps](/docs-csm/operations/rack_resiliency/ConfigMaps.md).