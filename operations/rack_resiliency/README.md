...
- Management Plane Failure Domain(MPFD): This constitutes one or more racks that have management nodes that make up the CSM management plane. In CSM 1.7.0, Rack Resiliency defines MPFD within a single rack.
