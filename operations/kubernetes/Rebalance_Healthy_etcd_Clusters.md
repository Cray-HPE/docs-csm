...
1. (`ncn-mw#`) Check to see if clusters have two or more pods on the same worker node.
...
1. (`ncn-mw#`) Delete one of the pods that is on the same node as another in the cluster.
