# Configure Kubernetes API Audit Log Parameters
...
## Configure Kubernetes API Audit Log Maximum age
...
4. If Kubernetes API Auditing is enabled, add `--audit-log-maxage=30` command line option to the Kubernetes API Server.
   ...
   Edit the `/etc/kubernetes/manifests/kube-apiserver.yaml` file, adding `--audit-log-maxage=30` as an option after `--audit-policy-file`.

   ```bash
   ncn-m# grep -n "\-\-audit" /etc/kubernetes/manifests/kube-apiserver.yaml 
   46:    - --audit-log-path=/var/log/audit/kl8s/apiserver/audit.log
   47:    - --audit-policy-file=/etc/kubernetes/audit/audit-policy.yaml
   48:    - --audit-log-maxage=30
   ```
...
## Configure Kubernetes API Audit Log Maximum Size
...
4. If Kubernetes API Auditing is enabled, add `--audit-log-maxsize=100` command line option to the Kubernetes API Server.
   ...
   Edit the `/etc/kubernetes/manifests/kube-apiserver.yaml` file, adding `--audit-log-maxsize=100` as an option after `--audit-policy-file`.
