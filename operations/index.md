...
Use the Boot Orchestration Service \(BOS\) to boot, configure, and shutdown collections of nodes.
   ...
   * [Compute Node Boot Sequence](boot_orchestration/Compute_Node_Boot_Sequence.md)
     ...
     * [Node Boot Root Cause Analysis](boot_orchestration/Node_Boot_Root_Cause_Analysis.md)
       ...
       * [Compute Node Boot Issue Symptom: Node Console or Logs Indicate that the Server Response has Timed Out](boot_orchestration/Boot_Issue_Symptom_Node_Console_or_Logs_Indicatate_that_the_Server_Response_has_Timed_Out.md)
       ...
       * [Troubleshoot Compute Node Boot Issues Using Kubernetes](boot_orchestration/Troubleshoot_Compute_Node_Boot_Issues_Using_Kuberentes.md)
