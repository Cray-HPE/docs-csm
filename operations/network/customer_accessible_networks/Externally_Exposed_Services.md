...
| System Management Health Prometheus    | `prometheus`   |                                            |                            |                    | Uses the IP address of OAuth2 Proxy Ingress (CMN)          |
...
| [UAI][uai]                             |                | `customer-access` or `customer-high-speed` | Yes (multiple)             | 22                 | There may be several of these, each with a unique ID       |
...
[uai]: ../../../glossary.md#user-access-instance-uai
