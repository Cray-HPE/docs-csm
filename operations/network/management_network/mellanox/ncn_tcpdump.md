...
This will make a `.pcap` file named `dhcp` in the current directory.
It will collect all DHCP traffic on the specified port.
This example is looking for DHCP traffic on interface `bond0.nmn0` (`10.252.0.0/17`).
