...
* The above output shows that KEA is allocating a lease to `10.104.0.23`.
* The lease MUST say `DHCP4_LEASE_ALLOC`; if it says `DHCP4_LEASE_ADVERT`, then there is likely a problem.
  Restarting KEA will fix this issue most of the time.
