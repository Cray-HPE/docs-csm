...
The edge refers to any interactions with the customer network or Internet
...
System refers to access by the machine to external (customer and/or Internet) resources.
E.g. Internal DNS lookups may resolve to an external DNS.

## Internal

Internal refers to node-to-node communication inside the system.
