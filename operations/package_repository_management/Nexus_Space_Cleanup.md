...
[Manage Repositories with Nexus](./Manage_Repositories_with_Nexus.md#delete-a-repository). To delete a repository out of the web UI first
...
Once authenticated click on **Browse** then the repo you want to remove an asset from then the asset itself (either the folder, component or asset),
then delete on the right side menu.
