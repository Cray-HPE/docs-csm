...
See [Ceph Object Gateway S3 API](https://docs.ceph.com/en/pacific/radosgw/s3/) for more information about compatibility.
...
The S3 API is available on systems at the following location: `https://rgw-vip.local`
