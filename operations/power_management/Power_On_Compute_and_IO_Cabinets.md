...
1. If the system does not have Cray EX liquid-cooled cabinets, proceed to step 7.
...
1. Make sure all system management network switches and Slingshot network switches are powered on in each rack and there are no error LEDS or hardware failures.
