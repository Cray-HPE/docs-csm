...
[S3FS](https://github.com/s3fs-fuse/s3fs-fuse) is a FUSE-based filesystem backed by Amazon [S3][s3].
...
S3FS maintains a [local cache](https://github.com/s3fs-fuse/s3fs-fuse/wiki/Fuse-Over-Amazon#details),
...
**Note**: Other arbitrary files and directories directly under `/var/lib/s3fs_cache` will **not** be pruned,
...
Also see [Troubleshoot S3FS Cache Cleanup](../utility_storage/Troubleshoot_S3FS_Cache_Cleanup.md).
