...
S3FS is a near POSIX filesystem. CSM uses it to provides temporary overflow storage, as well as to support SDU and NMD services to provide space for dumps.
