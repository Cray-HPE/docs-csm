...
* [Use cases for resetting services](#use-cases-for-resetting-services)
...
* [Command reference](#command-reference)
    ...
    * [Show routing and status for all devices](#show-routing-and-status-for-all-devices)
    * [Print real devices](#print-real-devices)
    * [Show the currently enabled network service](#show-the-currently-enabled-network-service)
...
1. `wicked.service`: The overarching service for spawning daemons and manipulating interface configuration.
...
1. `network.service`: Responsible for network configuration per interface; This does not reload `wicked`.
...
### Show the currently enabled network service
