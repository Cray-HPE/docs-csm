...
1. Verify that new hardware has been discovered.
    ...
    - The BMC has no connection to the HMN network. This is typically seen with the BMC of `ncn-m001`, because its BMC is connected to the site network.
...
1. Update workload manager configuration to include any newly added compute nodes to the system.
   ...
   - **If PBS Pro is the installed workload manager**: Contact HPE support.
