...
The [Power Control Service (PCS)][pcs] is used to directly control the power for nodes,
regardless of the state in [HSM][hsm]; PCS does not check if a node is disabled
in HSM.
