...
Use the following table to determine which version of the HPE Slingshot documentation applies to your Fabric Manager deployment:

| **Fabric Manager deployment model**           | **Documentation to use**          |
|-----------------------------------------------|-----------------------------------|
| Fabric Manager running as a Kubernetes pod    | HPE Slingshot 2.3.x documentation |
| Fabric Manager running on a bare metal server | HPE Slingshot 3.1.0 documentation |
