...
Remove product artifacts that were imported via various Cray products. These instructions provide guidance for removing Image Management Service (IMS) images, IMS recipes, and Git repositories present in the Cray Product Catalog from the system.
...
1. View the imported artifacts by printing them from the Cray Product Catalog ConfigMap.
    ...
    The following example shows the Cray System Management (CSM) product artifacts.
...
4. Remove the Gitea repositories or branches.
    ...
    **Gitea web interface:** 
       ...
       1. Log in to Gitea as the *crayvcs* user. 
          2. From the dashboard, select the repository to delete based on the name of the repository in the *clone_url* field of the product catalog.
          3. Click on "Settings" and scroll to the bottom of the page to the "Danger Zone" section. Follow the instructions to delete the repository.
