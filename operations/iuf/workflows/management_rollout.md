...
intended to be configured as iSCSI targets. For details, see [Management Node Personalization](../operations/configuration_management/Management_Node_Personalization.md) and [worker node personalization](../operations/iscsi_sbps/iscsi_sbps.md#1-worker-node-personalization)
