...
- SDU
    ...
    - If this is an upgrade, refer to or copy from the stored backup that was created in the [Preparation](preparation.md#4-save-system-state-before-upgrade) step.
- SAT
