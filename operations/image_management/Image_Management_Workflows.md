...
* [Troubleshooting IMS jobs](#troubleshooting-ims-jobs)
...
1. (`ncn-mw#`) Administrators may remove previously set image metadata.
    ...
    ```bash
    cray ims images update a506a6f6-54d9-4e5a-9e8d-1fc052d62504 --metadata-operation remove --metadata-key key --format toml
    ```
