...
Kiwi image descriptions. These compressed Kiwi image descriptions are referred to as "recipes." Kiwi-NG
builds images based on a variety of different Linux distributions, specifically SUSE, RHEL, and their derivatives.
Kiwi image descriptions must follow the Kiwi development schema. More information about the development schema
and the Kiwi-NG tool can be found in
[the Kiwi documentation](https://doc.opensuse.org/projects/kiwi/doc/).
...
* **COS image recipes**: COS image recipes contain a Linux environment with an HPE Cray customized kernel and optimized HPE Cray
