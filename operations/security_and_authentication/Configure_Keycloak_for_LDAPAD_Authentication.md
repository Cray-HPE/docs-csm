...
For more information on setting up LDAP federation, see
[the LDAP section of the Keycloak administrative documentation](https://www.keycloak.org/docs/latest/server_admin/index.html#_ldap).
...
These attributes are added to the users by adding a "User Attribute Mapper" to the LDAP User Federation object.
