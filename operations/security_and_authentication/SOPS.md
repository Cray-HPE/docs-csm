...
4. Export your tenant's k8s token from your tenant's secret.
    ...
    (`ncn-m001#`) Retrieve, parse, decrypt and export your tenant's k8s service account token.
    ```bash
...
1. [Perform a local checkout of your VCS](../configuration_management/Version_Control_Service_VCS.md)
