...
cp -pvrR ./*.md ./background ./install ./img ./introduction ./operations ./update_product_stream ./upgrade ./*example* %{buildroot}/usr/share/doc/metal/ | awk '{print $3}' | sed "s/'//g" | sed "s|$RPM_BUILD_ROOT||g" | tee -a INSTALLED_FILES
