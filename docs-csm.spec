...
cp -pvrR ./*.md ./background ./install ./img ./introduction ./lib ./operations ./scripts ./troubleshooting ./update_product_stream ./upgrade ./workflows ./*example* %{buildroot}/usr/share/doc/csm/ | awk '{print $3}' | sed "s/'//g" | sed "s|$RPM_BUILD_ROOT||g" | tee -a INSTALLED_FILES
