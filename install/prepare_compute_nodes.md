...
### Topics:
   * [Configure HPE Apollo 6500 XL645d Compute Nodes](#configure-hpe-apollo-6500-x645d-compute-nodes)

## Details

<a name="configure-hpe-apollo-x645d--compute-nodes"></a>
### Configure HPE Apollo 6500 XL645d Compute Nodes
  
The HPE Apollo 6500 XL645d Gen10 Plus comput node uses a NIC/shared iLO network port. The NIC is
