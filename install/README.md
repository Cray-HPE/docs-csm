...
- [Pre-installation](#pre-installation)
    ...
    1. [Initialize the LiveCD](#5-initialize-the-livecd)
    1. [Import the CSM tarball](#6-import-the-csm-tarball)
    1. [Validate the LiveCD](#7-validate-the-livecd)
    1. [Configure management network switches](#8-configure-management-network-switches)
...
- [Installation](#installation)
    ...
    1. [Update ceph node-exporter config for SNMP counters](#10-update-ceph-node-exporter-config-for-snmp-counters)
    1. [Upload Olympus BMC recovery firmware into TFTP server](#11-upload-olympus-bmc-recovery-firmware-into-tftp-server)
    1. [Update firmware with FAS](#12-update-firmware-with-fas)
    1. [Prepare compute nodes](#13-prepare-compute-nodes)
    1. [Troubleshooting installation problems](#14-troubleshooting-installation-problems)
...
> [Troubleshooting installation problems](#14-troubleshooting-installation-problems) and
...
### 5. Initialize the LiveCD

See [Initialize the LiveCD](pre-installation.md#4-initialize-the-livecd).

### 6. Import the CSM tarball

See [Import the CSM tarball](pre-installation.md#5-import-the-csm-tarball).

### 7. Validate the LiveCD

See [Validate the LiveCD](pre-installation.md#6-validate-the-livecd).

### 8. Configure management network switches
...
### 10. Update ceph node-exporter config for SNMP counters
...
### 11. Upload Olympus BMC recovery firmware into TFTP server
...
### 14. Troubleshooting installation problems
