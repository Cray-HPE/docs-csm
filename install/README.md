...
1. [Pre-installation](#pre-installation)
   ...
   4. [Configure management network switches](#4-configure-management-network-switches)
   5. [Identify inventory](#5-identify-inventory)
1. [Installation](#installation)
   ...
   8. [Update firmware with FAS](#8-update-firmware-with-fas)
   9. [Prepare compute nodes](#9-prepare-compute-nodes)
...
**This section is not yet complete and exists as a placeholder. Move on to [Installation](#installation).**
