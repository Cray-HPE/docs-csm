...
In some environments, during the [Deploy Final NCN reboot step](deploy_final_non-compute_node.md#4-reboot), `ncn-m001` may loop through all of its NICs and still fail to PXE boot,
