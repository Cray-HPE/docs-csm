...
Test 1: [link to nonexistent section of README](README.md#warning-rr-is-experimental)
...
Test 4: [link to nonexistent page](warning-rr-is-experimental.md)
...
1. (`external#`) Download the CSM software release from the public Artifactory instance.
   ...
   1. (`external#`) Set the CSM RELEASE version
      ...
      >
      > - An alpha build: `CSM_RELEASE=1.7.0-alpha.99`
      > - A release candidate: `CSM_RELEASE=1.7.0-rc.1`
      > - A stable release: `CSM_RELEASE=1.7.0`
