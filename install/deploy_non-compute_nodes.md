...
1. (`pit#`) Wait for the deployment to finish.
    ...
    1. Validate that all master and worker NCNs (except for `ncn-m001`) show up in the cluster.
        ...
        ncn-m002   Ready    control-plane,master   7m39s   v1.21.12   10.252.1.5    <none>        SUSE Linux Enterprise High Performance Computing 15 SP4   5.14.21-150400.24.38.1.25440.1.PTF.1204911-default   containerd://1.5.16
        ncn-m003   Ready    control-plane,master   7m16s   v1.21.12   10.252.1.6    <none>        SUSE Linux Enterprise High Performance Computing 15 SP4   5.14.21-150400.24.38.1.25440.1.PTF.1204911-default   containerd://1.5.16
        ncn-w001   Ready    <none>                 7m16s   v1.21.12   10.252.1.7    <none>        SUSE Linux Enterprise High Performance Computing 15 SP4   5.14.21-150400.24.38.1.25440.1.PTF.1204911-default   containerd://1.5.16
        ncn-w002   Ready    <none>                 7m18s   v1.21.12   10.252.1.8    <none>        SUSE Linux Enterprise High Performance Computing 15 SP4   5.14.21-150400.24.38.1.25440.1.PTF.1204911-default   containerd://1.5.16
        ncn-w003   Ready    <none>                 7m16s   v1.21.12   10.252.1.9    <none>        SUSE Linux Enterprise High Performance Computing 15 SP4   5.14.21-150400.24.38.1.25440.1.PTF.1204911-default   containerd://1.5.16
        ```
