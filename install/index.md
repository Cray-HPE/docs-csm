...
1. [Validate CSM health](#validate_csm_health_before_pit_redeploy)
...
1. Prepare configuration payload
   ...
   Information gathered from a [site survey](../introduction/site_survey.md) is needed to feed into the CSM installation process, such as system name,
...
1. Validate CSM health
   ...
   **Note**: At this point of the install, the `cray` CLI has not yet been configured. Some of the tests (Hardware State
   ...
   validation:
      ...
      1. [Configure the `cray` Command Line Interface (CLI)](configure_administrative_access.md#configure_cray_cli)
...
1. Update firmware with FAS
   ...
   **IMPORTANT:** Before FAS can be used to update firmware, refer to the 1.5 _HPE Cray EX System Software Getting Started Guide S-8000_
   on the [HPE Customer Support Center](https://www.hpe.com/support/ex-gsg) for information about how to install
