...
Note: If you are beginning an install with CSM 1.2.0, please download and proceed to install the latest released CSM 1.2.x patch version, instead. This will save you time performing a patch update later.
