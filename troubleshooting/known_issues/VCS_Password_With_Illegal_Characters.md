...
See [Software Management Services health checks](../../operations/validate_csm_health.md#sms-health-checks) for more information on running the test and locating its log file.
