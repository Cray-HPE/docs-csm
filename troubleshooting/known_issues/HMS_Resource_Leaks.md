...
Resource leaks have been discovered in several HMS services (PCS, SMD, hmcollector, and FAS).  The symptoms are quite varied and are generally not detremental to system functionality due to the resiliency provided by Kubernetes.  On this page we document the symptoms, known impacts to functionality, and include some examples of how to proactively check your system for this issue.
...
* Power status for components reported as "udefined"
