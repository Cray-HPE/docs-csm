...
1. Download and upgrade the latest documentation RPM.
   ...
   ```bash
   wget https://artifactory.algol60.net/artifactory/csm-rpms/hpe/stable/sle-15sp2/docs-csm/1.4/noarch/docs-csm-latest.noarch.rpm -O docs-csm-latest.noarch.rpm
