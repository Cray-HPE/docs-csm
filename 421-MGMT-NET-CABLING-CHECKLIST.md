...
![SHCD](img/network/SHCD-40G_10G.png)
    - Based on the vendor of the nodes and the name in the first colum we can determine how it's supposed to be cabled. 
...
|             | Based on the vendor of the node and the name in the first colum we can determine how it's supposed to be cabled.  |         |
