...
> **`NOTE`** It is not recommended to reboot compute nodes at the same time as workers nodes with DVS servers are being upgraded. This is to avoid restarting DVS clients and servers at the same time.
