...
See [Prepare for Upgrade to Next CSM Major Version](https://cray-hpe.github.io/docs-csm/en-14/upgrade/prepare_for_upgrade_to_next_csm_major_version/) in the CSM 1.4 documentation.
