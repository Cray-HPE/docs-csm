...
Follow one of these procedures when upgrading from CSM 1.4 to CSM 1.5 (regardless of patch version).
(Additionally, in the unusual situation of upgrading from a pre-release version of CSM 1.5.0, then one of these
procedure should be followed.)

There is no need to upgrade from CSM 1.4 to CSM 1.5.0, and then separately upgrade from CSM 1.5.0 to the
latest patch release. The procedures in this section can be used to upgrade from CSM 1.4 directly to the
latest patch release of CSM 1.5.
...
Follow one of these procedures when upgrading from CSM 1.5 to a newer patch version of CSM 1.5.
(The one exception is in the unusual situation of upgrading from a pre-release version of CSM 1.5.0;
...
* [CSM 1.5.4 Patch Installation Instructions](1.5.4/README.md)
* [CSM 1.5.3 Patch Installation Instructions](1.5.3/README.md)
